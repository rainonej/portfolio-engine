...
| `PdfViewer.astro`                       | Responsive PDF.js reader for same-origin documents, with continuous pages, selectable text, reader controls, lazy canvas rendering, and open/download fallbacks                                                                                 |
