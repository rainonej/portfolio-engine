...
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Theme route injection                                       | `/`, `/work`, `/work/[slug]`, `/writing`, `/writing/[slug]` are the primary theme routes used in nav. `/about`, `/contact`, and `/resume` are still injected by the theme (they exist for downstream consumers) but are hidden from this demo's top navigation because the demo is not a personal site.                                                                                                                                                                                                                            |
...
| Content collections                                         | [`src/content/profile`](src/content/profile/), [`projects`](src/content/projects/), [`writing`](src/content/writing/). The `testimonials` collection schema is preserved by [`src/content.config.ts`](src/content.config.ts) but the directory ships empty.                                                                                                                                                                                                                                                                          |
